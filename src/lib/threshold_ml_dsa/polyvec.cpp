...
/**************************************************************/
/************ Vectors of polynomials of length L_Param **************/
/**************************************************************/
...
* Name:        polyvecl_add
*
* Description: Add vectors of polynomials of length L_Param.
...
* Name:        polyvecl_ntt
*
* Description: Forward NTT of all polynomials in vector of length L_Param. Output
...
*
* Description: Pointwise multiply vectors of polynomials of length L_Param, multiply
...
*
* Description: Check infinity norm of polynomials in vector of length L_Param.
...
void polyveck_pack_w1(uint8_t r[DILITHIUM_K*DILITHIUM_POLYW1_PACKEDBYTES], const polyveck *w1) {
  unsigned int i;
